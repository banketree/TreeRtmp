...
package com.fuzhouxiu.coretransfer.jstun.header;
...
import com.fuzhouxiu.coretransfer.jstun.attribute.MessageAttribute;
import com.fuzhouxiu.coretransfer.jstun.attribute.MessageAttributeParsingException;
import com.fuzhouxiu.coretransfer.jstun.util.Utility;
import com.fuzhouxiu.coretransfer.jstun.util.UtilityException;
...
public class MessageHeader implements MessageHeaderInterface {
     ...
     * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 */
	private static String Tag = MessageHeader.class.getSimpleName();
	...
	public static MessageHeader parseHeader(byte[] data) throws MessageHeaderParsingException {
		try {
			...
			switch (type) {
			case BINDINGREQUEST: mh.setType(MessageHeaderType.BindingRequest); Log.i(Tag,"Binding Request received."); break;
			case BINDINGRESPONSE: mh.setType(MessageHeaderType.BindingResponse);  Log.i(Tag,"Binding Response received."); break;
			case BINDINGERRORRESPONSE: mh.setType(MessageHeaderType.BindingErrorResponse);  Log.i(Tag,"Binding Error Response received."); break;
			case SHAREDSECRETREQUEST: mh.setType(MessageHeaderType.SharedSecretRequest);  Log.i(Tag,"Shared Secret Request received."); break;
			case SHAREDSECRETRESPONSE: mh.setType(MessageHeaderType.SharedSecretResponse);  Log.i(Tag,"Shared Secret Response received."); break;
			case SHAREDSECRETERRORRESPONSE: mh.setType(MessageHeaderType.SharedSecretErrorResponse);  Log.i(Tag,"Shared Secret Error Response received.");break;
